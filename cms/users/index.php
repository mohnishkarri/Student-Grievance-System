...
{
$ret=mysqli_query($con,"SELECT * FROM users WHERE userEmail='".$_POST['username']."' and fullName='".$_POST['username1']."' and password='".md5($_POST['password'])."'");
...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff"><b>Complaint Managent System</b></h3>
	<hr />
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="username1" placeholder="College ID Number"  required autofocus autocomplete="off">
		            <br>
					<input type="text" class="form-control" name="username" placeholder="Enrollment Number"  required autofocus autocomplete="off">
		            <br>
...
<input type="text" name="contact" placeholder="contact No" autocomautoplete="off" class="form-control" required><br>
