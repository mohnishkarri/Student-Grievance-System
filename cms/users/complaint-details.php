...
<html lang="en">
  <head>
    ...
    <title>SGS | Complaint Details</title>
...
<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>College :</b></label>
              <div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Department :</b> </label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Complaint Level :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['complaintType']." level");?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>State :</b></label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Category :</b></label>
              <div class="col-sm-4">
              <p><?php $hi=mysqli_query($con,"select category from college");$r=mysqli_fetch_array($hi);echo htmlentities($r['category']);?></p>
              </div>
